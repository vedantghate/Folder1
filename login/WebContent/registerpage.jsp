                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <checkbox id='hob' multiple='true'>
                        <p><input TYPE=checkbox name=hobbies VALUE=Dancing> Dancing 
                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                           <input TYPE=checkbox name=hobbies VALUE=Singing> Singing </p>
                        <p><input TYPE=checkbox name=hobbies VALUE=Reading> Reading 
                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
                           <input TYPE=checkbox name=hobbies VALUE=Drawing> Drawing </p>
                        <p><input TYPE=checkbox name=hobbies VALUE=Swimming> Swimming 
                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
                           <input TYPE=checkbox name=hobbies VALUE=Sports> Sports </p>
